...
export default function Layout({ children }) {
  ...
  return (
    ...
    >
      ...
      <aside 
        id="sidebar"
        className={`fixed md:static inset-y-0 left-0 z-40 w-52 bg-[#1F1F1F] border-r border-[#374151] flex flex-col transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="p-3 border-t border-[#374151]">
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-3 py-2 bg-[#2A2A2A] text-white rounded-lg hover:bg-[#374151] transition-colors"
          >
